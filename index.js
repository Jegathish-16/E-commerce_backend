...
// creating end point registering user
...
// creating api for popular in women category
...
const fetchUser = async(req,res,next)=>{
    ...
    if(!token){
        ...
        try {
            ...
            res.status(401).send({errors:"Please authenticate usign a valid token"})
        }
    }
}
// creating end points for adding cart data
